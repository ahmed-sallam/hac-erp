...
return [
    ...
    */
    ...
    'decimal' => 'يجب أن يكون حقل :attribute عددًا يحتوي على :decimal أماكن عشرية.',
    ...
    'hex_color' => 'يجب أن يكون حقل :attribute لونًا هكساديسماليًا صحيحًا.',
    ...
    'lowercase' => 'يجب أن يكون حقل :attribute حروفه صغيرة.',
    'lt' => [
    ...
    'mimes' => 'يجب أن يكون نوع ملف :attribute من الأنواع التالية: :values.',
    'mimetypes' => 'يجب أن يكون نوع ملف :attribute من الأنواع التالية: :values.',
    'min' => [
    ...
    'password' => [
        ...
        'uncompromised' => 'لقد ظهرت القيمة المعطاة لـ :attribute في تسريب بيانات. الرجاء اختيار :attribute مختلفة.',
    ],
    ...
    'prohibited_unless' => 'حقل :attribute ممنوع مالم يكن :other في :values.',
    ...
    'size' => [
        ...
        'string' => 'يجب أن يكون حجم حقل :attribute :size أحرف.',
    ],
    ...
    'uppercase' => 'يجب أن يكون حقل :attribute في حالة أحرف كبيرة.',
